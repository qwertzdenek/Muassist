...
import ycdmdj.muassist.common.Tones;
...
public class Classificator {
     ...
     *
     * @param freq frequency for analysis
     * @param temp required temperament
     ...
     *
     * @param x the value whose log has to be computed.
     * @return real number
     */
     ...
     *
     * @param newVal new value (390 to 460)
     */
