...
public class MedianFilter {
    private class ResultEntry {
        private Classificator.Result res;
        public int age;

        public ResultEntry(Classificator.Result res) {
            this.res = res;
            this.age = 0;
        }
    }
    ...
    public void addValue(Classificator.Result val) {
        // make them older
    ...
    public Classificator.Result getMedian() {
        if (added == 0)
            return null;
        else
